...
import imges from "../../assets/hero.png";
      ...
      <div className="bg-[#F2F0F1]">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
          <div className="flex gap-[20px] md:gap-[32px] lg:gap-[32px] flex-col mt-[103px]">
            ...
            <button className="lg:w-[210px] md:w-[210px] sm:w-[210px] sd:w-[210px] w-full   py-[10px] bg-[#000] text-[#fff] font-[500] mb-6 border rounded-full">
              Shop Now
            </button>
          ...
          <div className="relative">
            <div>
              <img
                className="absolute top-[76px] right-0  lg:w-[104px] lg:h-[104px] md:w-[104px] md:h-[104px] sm:w-[96lg:px] sm:h-[9 sm:text-[36px] md:text-[36px] text-[24px] 6lg:px] w-[72px sm:text-[36px] md:text-[36px] text-[24px] ] h-[72px]"
                src={imges1}
                alt=""
              />
            </div>
            ...
            <div className="absolute top-[210px]">
              <img
                className="lg:w-[56px] lg:h-[56px] md:w-[56px] md:h-[56px] sm:w-[50px] sm:h-[50px] w-[42px] h-[42px]"
                src={imges2}
                alt=""
              />
            </div>
...
export default Hero;
// grid lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-3 sd:grid-cols-2 grid-cols-2
